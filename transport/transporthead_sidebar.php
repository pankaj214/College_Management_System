...
@media screen and (max-height: 850px) {
  ...
  <a href="librarian_availablebooks.php"><i class="fa fa-book" aria-hidden="true"></i> Available buses</a>
 
  <hr style="background-color:black;">
   
    <a href="librarian_duestudent.php"><i class="fa fa-question" aria-hidden="true"></i>Bus Fees Dues</a>
